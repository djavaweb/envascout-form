<div class="preview-caldera-config-group">
	...
	<div class="preview-caldera-config-field">
		<textarea {{#if hide_label}}placeholder="{{label}}"{{else}}placeholder="{{config/placeholder}}"{{/if}} rows="4" style="resize:none;" class="preview-field-config">{{config/default}}</textarea>
